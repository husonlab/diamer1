 ...
 */
public class HeaderSequenceRecord<T> implements Iterable<T> {
     ...
     */
    public HeaderSequenceRecord(String header, Sequence<T> sequence) {
        this.id = -1;
        this.header = header;
    ...
    public boolean equals(Object obj) {
        ...
        HeaderSequenceRecord<?> seq = (HeaderSequenceRecord<?>) obj;
    ...
    /**
     * Convenience method to create a {@link HeaderSequenceRecord} of a {@link CharSequence} with the {@link AlphabetDNA}.
     * @param header the header of the sequence
     * @param sequence the sequence
     * @return a new DNA SequenceRecord object
     */
    public static HeaderSequenceRecord<Character> DNA(String header, String sequence) {
        return new HeaderSequenceRecord<>(header, new CharSequence(new AlphabetDNA(), sequence));
    }

    /**
     * Convenience method to create a {@link HeaderSequenceRecord} of a {@link CharSequence} with the {@link AlphabetAA}.
     * @param header the header of the sequence
     * @param sequence the sequence
     * @return a new AA SequenceRecord object
     */
    public static HeaderSequenceRecord<Character> AA(String header, String sequence) {
        return new HeaderSequenceRecord<>(header, new CharSequence(new AlphabetAA(), sequence));
    }
}
