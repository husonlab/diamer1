...
public class MinimizerTest {
    ...
    public void testMinimizer() {
        ...
        System.out.println(Arrays.toString(kmerExtractor.extractKmers(sequence)));

        KmerExtractor kmerExtractor2 = new KmerExtractor(kmerEncoder, (kmer) -> true);
        System.out.println(Arrays.toString(kmerExtractor2.extractComplexityMaximizer(sequence)));
        System.out.println(Arrays.toString(kmerExtractor2.extractComplexityMaximizer(sequence)));
    }
}
